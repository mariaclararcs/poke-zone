...
export default function PokemonSearch({ onSearch }: PokemonSearchProps) {
    ...
    return (
        <div className="w-full flex flex-row gap-6 items-center justify-center px-4 sm:px-8 md:px-12 lg:px-20 py-4 xl:py-6">
            ...
            <div>
                <Select>
                    ...
                    <SelectContent>
                        <SelectItem value="lowest">Lowest Number (First)</SelectItem>
